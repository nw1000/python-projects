...
while main:
    ...
    background = pygame.image.load("hacker_background.png")
    ...
    compImg = pygame.image.load("computer.png")

    playImg = pygame.image.load("Play_Button.png")
    play_x = 225
    play_y = 225

    settingsImg = pygame.image.load("how_to.png")
    settings_x = 277
    settings_y = 380
    ...
    for i in range(number_of_enemies):
        enemyImg.append(pygame.image.load("hacker.png"))
    ...
    settings_font = pygame.font.SysFont("calibri.ttf", 40)
    ...
    def settings_title():
        title_text = settings_title_font.render("How to play", True, (255, 255, 255))
    ...
    while home:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if settings_x + 250 > mouse_pos[0] > settings_x and settings_y + 100 > mouse_pos[1] > settings_y:
                    settings = True
                    home = False
    ...
    while settings:
        ...
        settings_text("Use the space bar to shoot and the arrow keys to move.", 1)
        settings_text("Stop the hackers from hacking the computers.", 2)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if back_arrow_x + 63 > mouse_position[0] > back_arrow_x and back_arrow_y + 100 > mouse_position[
                    1] > back_arrow_y:
                    home = True
                    settings = False
